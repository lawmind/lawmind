...
const LIGHT_TASKS = new Map([
  ...
  [
    'cx1-citation-graph-census-refresh',
    {
      command: process.execPath,
      args: ['scripts/cx1-citation-graph-census.mjs'],
      display: 'node scripts\\cx1-citation-graph-census.mjs',
    },
  ],
  [
    'cx1-premium-backend-lab-refresh',
    {
      command: process.execPath,
      args: ['scripts/cx1-premium-backend-lab.mjs'],
      display: 'node scripts\\cx1-premium-backend-lab.mjs',
    },
  ],
  [
    ...
    {
      command: process.execPath,
      args: ['scripts/cx1-selector-runner-smoke.mjs'],
      display: 'node scripts\\cx1-selector-runner-smoke.mjs',
    },
  ],
  [
    'cx1-retrieval-matrix-refresh',
    {
      command: process.execPath,
      args: ['scripts/cx1-retrieval-matrix.mjs'],
      display: 'node scripts\\cx1-retrieval-matrix.mjs',
    },
  ],
  [
    'cx1-disaster-recovery-drill-refresh',
    {
      command: process.execPath,
      args: ['scripts/cx1-disaster-recovery-drill.mjs'],
      display: 'node scripts\\cx1-disaster-recovery-drill.mjs',
    },
  ],
  [
    'cx1-final-packet-refresh',
    {
      command: process.execPath,
      args: ['scripts/cx1-heavy-lab-final.mjs'],
      display: 'node scripts\\cx1-heavy-lab-final.mjs',
    },
  ],
]);
