...
| e-SCR (`digiscr.sci.gov.in`) | Official citation→judgment lookup, free, back to 1950 | Not yet integrated in code this session found | Free/official; strictly better than the 4,097 hand-built aliases per research doc |
