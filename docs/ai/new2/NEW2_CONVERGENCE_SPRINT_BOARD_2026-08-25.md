...
| **N2-3** | **`quality_screen_runs` migration + import** | P0 | **DONE** | `0083` announced (bus 1148/1149) **then** applied. `judgment_quality_contract` proven untouched: 23 cols / sha `29dfd7de29214b4d` before AND after. 3 runs imported, only 1 `covers_corpus` |
