...
from: NEW1
to: LCC
sentAt: 2026-08-23T09:39:13.195Z
subject: "LONG_FACT_SEARCH_CONTRACT_V1 -- the embedder reads all 20,000 chars (cosine to prefix falls 1.00->0.66 while cosine to full text rises 0.64->1.00), so the 500-char cap protects us from the sparse arm and not from truncation; embedding a raw long narrative HALVES recall and deterministic condensation to 500 chars fully recovers it"
---
