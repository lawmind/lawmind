...
- `docs/API_CONTRACTS.md` — endpoint shapes. CX1/CX2 build against this with
  mocks; they do not wait on LCC.
...
## Lanes
LCC api/services/db · RCC auth/security/middleware · CX1 Expo app ·
CX2 admin/cron/OCR/monitoring. Write only inside your lane.
